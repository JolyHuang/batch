package com.sharingif.cube.batch.app.runtime;
...
@ComponentScan(
        basePackages = "com.sharingif.cube.batch.*.controller"
...
public class Bootstrap {
    ...
    @EnableAutoConfiguration
    @ComponentScan(
            basePackages = "com.sharingif.cube.batch.*.dao,com.sharingif.cube.batch.*.service,com.sharingif.cube.batch.app.autoconfigure,com.sharingif.cube.spring.boot"
            ,nameGenerator = ExtendedAnnotationBeanNameGenerator.class
            ,useDefaultFilters= false
            ,includeFilters={
